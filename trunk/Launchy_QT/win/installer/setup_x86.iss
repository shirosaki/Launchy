...
#define MyAppName      "Launchy3"
#define MyAppVerName   "Launchy3 2.9.0"
#define MyAppPublisher "OpenNingia"
#define MyAppURL       "http://openningia.github.com/Launchy/"
#define MyAppExeName   "Launchy3.exe"
#define MyAppUrlName   "Launchy3.url"
...
OutputDir=Release\
OutputBaseFilename=Launchy3_x86
...
Source: LaunchyPortable.ini; DestDir: {app}; DestName: Launchy3.ini; Flags: onlyifdoesntexist; Check: IsPortable
...
; Translations
Source: ..\..\translations\launchy_fr.qm; DestDir: {app}\tr\; Flags: ignoreversion
...
Name: {code:UserOrCommonDirectory|programs}\{groupname}\Launchy3 Rescue Mode; Filename: {app}\{#MyAppExeName}; WorkingDir: {app}; Parameters: /rescue
...
begin
  PortablePage := CreateInputOptionPage(wpLicense,
    'Installation Type', 'How should Launchy3 be installed?',
    'Launchy3 can run as an installed application or in portable mode. Please select your preferred mode',
    True, False);
